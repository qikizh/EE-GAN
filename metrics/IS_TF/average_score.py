...
tf.app.flags.DEFINE_string('checkpoint_dir',
                           '/home/zhaoqike/MixNMatch-master/code/Evaluation_Metrics/inception_finetuned_models/birds_valid299/model.ckpt',
                           """Path where to read model checkpoints.""")

tf.app.flags.DEFINE_string('image_folder', '/home/zhaoqike/eval_for_tf/wholeStage/fake256', """Path where to load the images """)
...
def preprocess(img):
    ...
    img = Image.fromarray(img).resize(size=(299, 299))
